            ...
            <div className="max-w-2xl mx-auto">
              <Card className="bg-gray-900 border-gray-800 p-4 sm:p-6 rounded-xl shadow-xl">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    className="w-full h-12 mt-6 bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-500 hover:to-teal-600 border-0 rounded-lg shadow-lg shadow-teal-500/20 transition-all"
                  >
                    Execute Repayment
                  </Button>
                </div>
